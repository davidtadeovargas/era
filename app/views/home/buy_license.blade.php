...
@section('meta_section')
    ...
    <title>Compra tu licencia ERA</title>
...
@section('body_section')
	...
	<div class="remodal-bg">
		...
		<div class="remodal" data-remodal-id="license_payment_successfull_modal"
		  ...
		  <p>
		    La compra de tu licencia fue exitosa, te hemos enviado un correo con tu información de registro y número de licencia. Muchas gracias!
		  </p>
		  <br>		  
		...
		<div id="licenseInfo">
			<div class="row">
				<div class="title-box" style="text-align: center;">
					<h1>TERMINA TU COMPRA</h1><br><br><br>
				</div>
			</div>			
			<div class="row">
				<div class="col-sm-12">
					<div class="title-box" style="text-align: center;">
						<h2>Licencias actuales:</h2>
					</div>
					<div class="row">
						<div class="col-sm-2">
						</div>
		...
		<div id="comraLicenciaMenu" class="gallery-box">
			<div class="container-fluid">
				<div class="row">
					<div class="col-sm-12">
						<div class="title-box" style="text-align: center;">
							<h2>Revisa tu pedido</h2>
							<p>Estas a unos pasos de adquirir tu producto</p>							
						</div>
					</div>
				</div>
				<div class="clearfix"></div> <br><br>
					...
					<div class="col-md-4">
	                    <form action="/process/payment" method="POST" id="card-form" role="form">
	                        ...
	                        <div class="form-group">
	                            ...
	                            <input type="text" class="form-control" id="nombretarjetahabiente" maxlength="60" placeholder="Ej. Oscar Robles Torres" size="20" data-conekta="card[name]" />
	                        </div>
	                        <div class="form-group">
	                            <label for="tarjeta">Número de la tarjeta de crédito</label>
	                            <input type="text" maxlength="19" class="form-control" id="tarjeta" placeholder="Ej. 87129873" size="20" data-conekta="card[number]" />
	                        </div>
	                        <div class="form-row">
	                            <label>
	                                <span>CVC</span>
	                                <input type="number"  min="100" max="999" maxlength="4" size="4" id="cvc" data-conekta="card[cvc]" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
	                            </label>
	                        </div>	                        
	                        <div class="form-row">
	                            <label>
	                                <span>Fecha de expiración (MM/AA)</span>
	                                <input type="number" min="01" max="12" size="2" maxlength="2" id="expirationMonth" data-conekta="card[exp_month]" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
	                                <span>/</span>
	                            	<input type="number" min="19" max="99" size="2" maxlength="2" id="expirationYear" data-conekta="card[exp_year]" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
	                            </label>                            
	                        </div>
	                        <button style="min-width:  100%" id="processPayment" class="btn btn-success" type="submit">Procesar pago</button>	                        
	                        <div class="clearfix"></div>	                        
	                        <div class="clearfix"></div> <br>	                         
	                    </form>
	            	</div>
