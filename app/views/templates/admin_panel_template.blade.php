        ...
        <nav class="navbar header-nav navbar-expand-lg">
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                        <li><a class="nav-link active" href="/admin_panel">Home</a></li>
                        <li><a class="nav-link" href="/shopping_cart">Compra de licencia</a></li>
                        <li><a class="nav-link" href="/revoque_activate_license">Revocación</a></li>
                        <li><a class="nav-link" href="#" id="cerrarSessionMenu">Cerrar Sesión</a></li>  
